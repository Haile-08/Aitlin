...
function DocumentModal({setIsOpen, documents, serviceId}: any) {
  ...
  return (
    <div className="z-50 flex justify-center items-center w-dvw h-dvh bg-slate-900 bg-opacity-40 absolute">
        <div className="z-50 w-[95%] md:w-1/3 h-2/3 flex justify-start items-center flex-col bg-white rounded-3xl p-3">
