    ...
    <div className="w-dvw h-dvh bg-banner-color flex justify-start items-center flex-col ">
      ...
      <div className="w-full md:w-10/12 bg-white h-[90%] md:h-[87%] rounded-none md:rounded-xl flex justify-start items-center flex-col shadow-md">
        <div className="w-[95%] h-[15%] md:h-[10%]  flex justify-between items-center flex-col md:flex-row">
            ...
            <button className="flex bg-primary-color font-roboto text-white justify-center items-center px-4 py-3 md:px-3 md:py-2 text-xs md:text-lg m-2 rounded-2xl" onClick={handleAddServiceNav}>
              <img src={add} alt="add" className="mr-0 md:mr-3" />
              <p className="hidden md:flex">Agregar nuevo</p>
            </button>
            <button className="flex bg-primary-color font-roboto text-white justify-center items-center px-4 py-3 md:px-3 md:py-2 text-xs md:text-lg m-2 rounded-2xl" onClick={handleMassUpload}>
        ...
        <div className="w-[95%] h-[5%] md:h-[7%] rounded-xl  flex justify-start items-center bg-gray-100">
          <div className="ml-1 md:ml-4 w-[40%] md:w-[20%] h-[90%] flex justify-start items-center font-roboto font-semibold">
