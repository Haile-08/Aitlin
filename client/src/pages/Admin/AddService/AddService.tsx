...
function AddService() {
  ...
  return (
    <div className="w-dvw h-dvh bg-banner-color flex justify-start items-center flex-col ">
        ...
        <div className="w-[95%] md:w-[90%] bg-white h-[75%] md:h-[45%] rounded-xl flex justify-start items-center flex-col shadow-md">
            {isLoading && <div className="w-[90%] h-[45%] bg-primary-color flex items-center justify-center absolute rounded-xl top-[10%] left-[5%] bg-opacity-20">
            ...
            <div className="w-[95%] h-[15%] flex justify-start items-end">
                <p className='mt-10 md:mt-0 mt-5text-primary-color text-lg font-semibold mb-5'>Ingresa la información del servicio para continuar</p>
            </div>
            <form className="w-[97%] flex justify-start flex-wrap">
                <div className="m-3">
                    ...
                    <select id="countries"  {...register("status")} className="bg-gray-50 border font-light border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 md:w-96 py-2.5 px-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div className='m-3'>
                    ...
                    <input type="text" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 md:w-96 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Nombre" required {...register("Name")}/>
                ...
                <div className='m-3'>
                    ...
                    <input type="text" id="last_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-80 md:w-96 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Servicio" required {...register("Service")}/>
            ...
            <div className="w-[95%] ml-5 md:ml-0 mt-10 flex justify-start items-center">
                <input checked={false} id="bordered-checkbox-1" onChange={() => setNotification(/* e.target.checked*/false)} type="checkbox" value="" name="bordered-checkbox" className="w-5 h-5 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
        ...
        <div className="w-10/12 h-[10%] flex justify-end items-center ">
            <button className='w-full md:w-28 bg-primary-color text-white px-28 py-3 rounded-lg flex justify-center items-center' onClick={handleSubmit(onSubmit)}>Agregar</button>
        </div>
    </div>
  )
}
