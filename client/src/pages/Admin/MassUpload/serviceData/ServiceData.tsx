...
function ServiceData() {
  ...
  const navigate = useNavigate();
   ...
   const { mutateAsync, isSuccess } = useMutation(addServiceData, {
     onSuccess: (data) => {
       console.log(data);
     },
     onError: () => {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center flex-col">
      {isSuccess || loading && <div className="w-full h-full bg-primary-color flex items-center justify-center absolute top-0 left-0  bg-opacity-20">
